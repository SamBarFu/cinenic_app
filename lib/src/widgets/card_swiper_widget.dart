        ...
        children: [
          ...
          Positioned(
              ...
              child: ClipRRect(
                borderRadius: BorderRadius.circular(50.0),
                child: Container(
                    color: Colors.black54, child: _infoCardMovie(index)),
              )),
  ...
  Widget _getTitle() {
    return Container(
      ...
      child: Column(
          ...
          children: <Widget>[
            Row(children: <Widget>[
              Icon(Icons.calendar_today, size: 30.0, color: Colors.white),
              SizedBox(width: 10.0),
              Text(
                movies[indexMovie].releaseDate,
                style: TextStyle(
                  fontSize: 25.0,
                  color: Colors.white,
                ),
